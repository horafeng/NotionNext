...
module.exports = {
  ...
  // 音乐播放插件
  <iframe frameborder="no" border="0" marginwidth="0" marginheight="0" width=宽度参数 height=高度参数 src="https://i.y.qq.com/n2/m/outchain/player/index.html?songid=316337023&songtype=0"></iframe>
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    ...
    },
    {
      name: 'Flower Dance',
      artist: 'DJ Okawari',
      url: 'http://music.163.com/song/media/outer/url?id=22676167.mp3',
      cover:
        'https://p1.music.126.net/kn6ugISTonvqJh3LHLaPtQ==/22676167.jpg'
    }
  ],
